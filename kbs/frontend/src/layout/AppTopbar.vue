...
const goToMemberAdd = () => {
    router.push('/login/cpMemberAdd')
};

// 로고 클릭 시 회원 타입에 따른 라우팅
const handleLogoClick = () => {
    const memType = user.value?.memType;
    
    // p2, p3 회원은 현재 페이지 유지 (아무 동작 안함)
    if (memType === 'p2' || memType === 'p3') {
        return;
    }
...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <!-- router-link를 button으로 변경하고 클릭 이벤트 추가 -->
            <button @click="handleLogoClick" class="layout-topbar-logo" style="background: none; border: none; cursor: pointer;">
